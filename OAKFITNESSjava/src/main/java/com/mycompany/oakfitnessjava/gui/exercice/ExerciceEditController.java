 ...
 * @author Heni Nechi
 */
public class ExerciceEditController implements Initializable {
    ...
    @FXML
    private void EditExercice(ActionEvent event) {
        ...
        excrud.ModifierExercice(e, Integer.parseInt(eid.getText()));
    ...
    void set(Exercice e){
        this.eid.setText(String.valueOf(e.getIDExercice()));
    this.tfname.setText(e.getNomExercice());
    this.tadescr.setText(e.getDescrExercice());
    this.tfmuscle.setText(e.getMuscle());
    this.tfurl.setText(e.getVideo());
    this.cbdiff.setValue(e.getDiffExercice());
    this.cbog.setValue(e.getJusteSalleExercice());
    this.cbtype.setValue(e.getTypeExercice());
    this.tfduration.setText(e.getDureeExercice());
